...
then
	...
	wp user create  --allow-root $WORDPRESS_USER $WORDPRESS_USER_EMAIL --role=author --user_pass=$WORDPRESS_USER_PASS --display_name=user1
	wp user create  --allow-root $WORDPRESS_USER_2 $WORDPRESS_USER_EMAIL_2 --role=author --user_pass=$WORDPRESS_USER_PASS_2 --display_name=user2
fi
